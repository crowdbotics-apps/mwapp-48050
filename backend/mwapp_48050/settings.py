"""
Django settings for mwapp_48050 project.
...
WSGI_APPLICATION = 'mwapp_48050.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mwapp_48050 API",
    "DESCRIPTION": "API documentation for mwapp_48050 App",
    "VERSION": "v1",
}
